/*
   ...
   Superamento dell'attesa attiva
   o busy waiting mediante la 
   CONDITION_VARIABLE che sospende
   il processo che non può avanzare. 
*/
...
CONDITION_VARIABLE cv;// variabili condizione
