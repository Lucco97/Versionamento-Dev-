/*
   v2 - Produttore e Consumatore.
   Introduco delle variabili BOOLEAN
   che mi permettono di capire se
   il dato è stato letto o scritto:
   buffer empty (letto) e buffer
   full (scritto); ora ottengo
   la stretta alternanza: P/C/P/C...
   
   In questo esempio la variabile condivisa
   full non è protetta da una sezione
   critica!
